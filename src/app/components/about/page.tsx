...
<div className="md:flex grid grid-cols-1">
        ...
        <div>
            ...
            <p className="font-semibold text-gray-400 md:ml-[200px] ml-0">Problems trying to resolve the conflict between the two major realms of<br/> Classical physics: Newtonian mechanics </p>
...
<div>
            ...
            <div className="mt-44 flex items-center justify-center relative">
                <img src="/scene.jpeg" alt="" className="w-[989px] h-[540px] rounded-lg">
...
<div className="md:flex items-center justify-evenly mt-20 mb-44 grid grid-cols-1 ml-10">
            <div>
                <img src="/abt1.jpeg" alt="" className="w-[316px] h-[231px]"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt2.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt3.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
...
<div className="bg-blue-500 md:w-[1440px] md:h-[636px] md:col-span-2 w-[500px] h-[900px ]">
    ...
    <p className="text-gray-300 md:ml-[200px] mt-6 ">The gradual accumulation of information about atomic and<br/> small-scale behavior during the first quarter of the 20th </p>
   <button  className=" w-[212px] h-[52px] text-white mt-11 flex items-center justify-center border border-white font-semibold rounded-sm md:ml-[200px] ml-20">Button</button>
    </div>
    <img src="/pinkgirl.jpeg" alt="" className="md:w-full md:h-full"/>
</div>
