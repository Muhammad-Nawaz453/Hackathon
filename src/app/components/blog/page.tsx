...
<IoIosArrowForward className="text-gray-500"/>
            ...
            <div className="w-[1440px] h-[530px] bg-white mt-20">
                <div className="flex">
                    <img src="/blg5.jpeg" alt="" className="w-[700px] h-[530px]"/>

                    <div className="grid grid-cols-2 ml-2 gap-2">
                        <img src="/blg1.jpeg" alt="" className="w-[361px] h-[260px]"/>
                        <img src="/blg2.jpeg" alt="" className="w-[361px] h-[260px]"/>
                        <img src="/blg3.jpeg" alt="" className="w-[361px] h-[260px]"/>
                        <img src="/blg4.jpeg" alt="" className="w-[361px] h-[260px]"/>
                    </div>
                </div>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            < div className="md:flex items-center justify-evenly mt-20 mb-44 grid grid-cols-1 ml-10">
            <div>
                <img src="/abt4.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt5.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt6.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            < div className="md:flex items-center justify-evenly mt-20 mb-44 grid grid-cols-1 ml-10">
            <div>
                <img src="/abt7.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt8.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
        ...
        <FaTwitter className="w-7 h-7"/>
            ...
            <div>
                <img src="/abt9.jpeg" alt="" className="w-[316px] h-[231px]"/>
                <h1 className="text-blue-950 font-semibold text-center mt-5">Username</h1>
                <p className="text-gray-500 text-center mt-2">Profession</p>
                <div className="flex space-x-2 text-sky-500 mt-2 items-center justify-center">
                <FaInstagram className="w-7 h-7"/>
